-- Fix critical SQL bug in get_metro_inventory body_style_breakdown
-- The grouping was inconsistent causing incorrect analytics
...
COMMENT ON FUNCTION get_metro_inventory IS 'Returns inventory by DMA (or city, state fallback). Fixed grouping logic for correct body_style rankings.';
