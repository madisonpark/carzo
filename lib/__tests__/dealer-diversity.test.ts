...
const createVehicle = (id: string, dealerId: string, dealerName?: string): MockVehicle => ({
  id,
  dealer_id: dealerId,
...
describe('diversifyByDealer()', () => {
  describe('Edge cases', () => {
    ...
    it('should return all vehicles when count < limit', () => {
      const vehicles = [
        createVehicle('1', 'dealer-a'),
        createVehicle('2', 'dealer-b'),
      ];

      expect(diversifyByDealer(vehicles, 10)).toEqual(vehicles);
    });
...
describe('prioritizeDifferentDealers()', () => {
  it('should prioritize vehicles from different dealers', () => {
    ...
    const result = prioritizeDifferentDealers(currentVehicle, relatedVehicles, 3);
  ...
  it('should include same dealer vehicles if limit not met', () => {
    ...
    const result = prioritizeDifferentDealers(currentVehicle, relatedVehicles, 4);
    ...
    const sameDealerCount = result.filter(v => v.dealer_id === 'dealer-a').length;
  ...
  it('should handle when all related vehicles are from same dealer', () => {
    ...
    const result = prioritizeDifferentDealers(currentVehicle, relatedVehicles, 2);
  ...
  it('should apply diversification to final result', () => {
    ...
    const result = prioritizeDifferentDealers(currentVehicle, relatedVehicles, 6);
  ...
  it('should handle limit of 0', () => {
    ...
    const result = prioritizeDifferentDealers(currentVehicle, relatedVehicles, 0);
