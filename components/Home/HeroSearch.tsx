    ...
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      >
        <div className="flex items-center gap-3 flex-1">
          <Search className="w-5 h-5 sm:w-6 sm:h-6 text-slate-400 group-hover:text-brand transition-colors shrink-0" />
          <input
            type="text"
            value={searchQuery}
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 text-white text-sm">
        ...
        <div className="bg-white/20 backdrop-blur-sm rounded-lg px-4 py-2 w-full sm:w-auto max-w-xs">
          <ZipCodeInput
            ...
            className="w-full [&_input]:bg-white [&_input]:text-slate-900 [&_input]:border-white/30 [&_.text-muted-foreground]:text-slate-400"
          />
        </div>
      </div>
    </div>
